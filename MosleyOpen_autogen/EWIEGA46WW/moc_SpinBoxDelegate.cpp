...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_SpinBoxDelegate_t::offsetsAndSizes) + ofs), len
Q_CONSTINIT static const qt_meta_stringdata_SpinBoxDelegate_t qt_meta_stringdata_SpinBoxDelegate = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_SpinBoxDelegate[] = {
...
Q_CONSTINIT const QMetaObject SpinBoxDelegate::staticMetaObject = { {
    ...
    qt_meta_stringdata_SpinBoxDelegate.offsetsAndSizes,
    qt_meta_data_SpinBoxDelegate,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_SpinBoxDelegate_t,
        // Q_OBJECT / Q_GADGET
